...
var ProtectedListPage = (0, import_react.lazy)(() => import("./settings-MAXKLBVM.js").then((mod) => ({
  default: mod.ProtectedListPage
})));
var ProtectedEditPage = (0, import_react.lazy)(() => import("./id-OCMNVPMS.js").then((mod) => ({
...
//# sourceMappingURL=router-JW7LNITN.js.map

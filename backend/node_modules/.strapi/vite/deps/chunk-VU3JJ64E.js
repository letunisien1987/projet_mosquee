import {
  ...
  StageColumn,
  getDisplayName
} from "./chunk-XVH56CZM.js";
import {
  buildValidParams as buildValidParams2
} from "./chunk-AK5CFNWL.js";
import {
  getStageColorByHex
} from "./chunk-A4NQ32GH.js";
import {
  LimitsModal
} from "./chunk-CTMHQUCC.js";
import {
...
} from "./chunk-OAIZXKWD.js";
import {
  useTypedSelector
} from "./chunk-7NKOR24L.js";
import {
  ...
  useGetLocalesQuery,
  useGetSettingsQuery
} from "./chunk-TCVXTZGI.js";
import {
  ReleaseActionMenu,
  ReleaseActionOptions
} from "./chunk-7OGOOU5H.js";
import {
  index
} from "./chunk-L2GFU5CM.js";
import {
...
import {
  ...
  usePersistentState,
  useSelectionState
} from "./chunk-W4JQ5FSM.js";
import {
  useConfig,
  useTracking
} from "./chunk-ODXZKCQD.js";
import {
  AssetSource,
  AssetType,
...
import {
  ...
  reducer2,
  require_baseUniq
} from "./chunk-TC7JQG2H.js";
import {
  pluginId
} from "./chunk-H4GPAAVJ.js";
import {
  useDocumentActions
} from "./chunk-WEI5GB4J.js";
import {
  buildValidParams,
  useContentManagerContext,
  useDocument,
  useDocumentLayout
} from "./chunk-CTHFPHCE.js";
import {
  renderAdmin
} from "./chunk-7VWK7FPD.js";
import {
  useAIAvailability
} from "./chunk-JGL2EFET.js";
import {
  useLicenseLimits
} from "./chunk-Y7C5X6HB.js";
import {
  Table,
  useTable
} from "./chunk-V7OPMARF.js";
import {
  useField,
  useForm
...
var index2 = {
  register(app) {
    ...
    app.addMenuLink({
      ...
      Component: () => import("./App-2OUBD4AV.js"),
      position: 5
    });
    app.registerPlugin({
      id: pluginId,
  ...
  register(app) {
    app.createSettingSection({
    ...
    }, [
      {
        ...
        id: "settings",
        to: "email",
        Component: () => import("./Settings-GYMAX2DG.js").then((mod) => ({
...
var admin2 = {
  register(app) {
    app.addMenuLink({
      ...
      Component: () => import("./App-7IT7OA3S.js").then((mod) => ({
        default: mod.Upload
      })),
      position: 4
    });
    app.addSettingsLink("global", {
      ...
      async Component() {
        const { ProtectedSettingsPage } = await import("./SettingsPage-ZQMLYSAB.js");
        return {
          ...
          children: [
            ...
            (0, import_jsx_runtime17.jsx)(Table.Body, {
              children: rows.map(({ locale, status }, index4) => {
                ...
                return status && locale ? (0, import_jsx_runtime17.jsxs)(Table.Row, {
                  children: [
...
var LocaleOptionStartIcon = ({ entryWithLocaleExists, translationStatus, index: index4 }) => {
  ...
  if (!entryWithLocaleExists) {
    return (0, import_jsx_runtime18.jsx)(ForwardRef$G, {});
  }
  if (isAiAvailable && index4 !== 0 && translationStatus === "failed") {
    return (0, import_jsx_runtime18.jsx)(ForwardRef$2, {
      fill: "warning600"
    });
  }
  return null;
        ...
        return {
          _render: () => {
            ...
            return (0, import_jsx_runtime18.jsxs)(React13.Fragment, {
              children: [
                (0, import_jsx_runtime18.jsx)(SingleSelectOption, {
                  disabled: !permissionsToCheck.includes(locale.code),
                  startIcon: (0, import_jsx_runtime18.jsx)(LocaleOptionStartIcon, {
                    entryWithLocaleExists,
                    translationStatus: (_a3 = jobData == null ? void 0 : jobData.data) == null ? void 0 : _a3.status,
                    index: index4
                  }),
                  value: locale.code,
                  children: (0, import_jsx_runtime18.jsx)(LocaleOption, {
                ...
                localesSortingDefaultFirst.length > 1 && index4 === 0 && (0, import_jsx_runtime18.jsx)(Box, {
                  paddingRight: 4,
                  paddingLeft: 4,
                  paddingTop: 2,
                  paddingBottom: 2,
...
var AITranslationStatusIcon = dt(Status)`
  display: flex;
...
var AITranslationStatusAction = ({ documentId, model, collectionType }) => {
  ...
  return {
    _status: {
      message: (0, import_jsx_runtime18.jsx)(Box, {
        height: "100%",
        "aria-label": formatMessage({
          id: getTranslation("CMEditViewAITranslation.status-aria-label"),
          defaultMessage: "AI Translation Status"
        }),
        children: (0, import_jsx_runtime18.jsx)(AITranslationStatusIcon, {
          $isAISettingEnabled: Boolean(isAISettingEnabled),
          variant: statusVariant,
          size: "S",
          children: status === "processing" ? (0, import_jsx_runtime18.jsx)(SpinningLoader, {}) : (0, import_jsx_runtime18.jsx)(ForwardRef$o, {})
        })
      }),
      tooltip: (0, import_jsx_runtime18.jsxs)(Flex, {
        direction: "column",
        padding: 4,
        alignItems: "flex-start",
        width: "25rem",
...
var LocalePicker = () => {
  ...
  const sortedLocaleOptions = React14.useMemo(() => {
    ...
    return displayedLocales.sort((a, b) => a.name.localeCompare(b.name)).map((locale) => (0, import_jsx_runtime20.jsx)(SingleSelectOption, {
      value: locale.code,
      children: locale.name
    }, locale.id));
  }, [
...
var LabelAction = ({ title, icon }) => {
  ...
  return (0, import_jsx_runtime21.jsxs)(Span, {
    ...
    children: [
      ...
      (0, import_jsx_runtime21.jsx)(TooltipImpl, {
        label: formatMessage(title),
        children: React15.cloneElement(icon, {
          "aria-hidden": true,
          focusable: false
        })
      })
...
var LocaleListCell = ({ locale: currentLocale, localizations, documentId }) => {
  ...
  return (0, import_jsx_runtime22.jsxs)(Menu.Root, {
    children: [
      (0, import_jsx_runtime22.jsx)(Menu.Trigger, {
        children: (0, import_jsx_runtime22.jsx)(Flex, {
          minWidth: "100%",
          alignItems: "center",
          justifyContent: "center",
          fontWeight: "regular",
      ...
      (0, import_jsx_runtime22.jsx)(Menu.Content, {
        children: localesForDocument.map(({ code, name: name2 }) => (0, import_jsx_runtime22.jsx)(Menu.Item, {
          onClick: (e) => {
            e.stopPropagation();
...
var index3 = {
  ...
  bootstrap(app) {
    ...
    app.addSettingsLink("global", {
      ...
      Component: () => import("./SettingsPage-JCIXCYNA.js").then((mod) => ({
        default: mod.ProtectedSettingsPage
      })),
  ...
  register(app) {
    ...
    if (window.strapi.features.isEnabled("cms-content-releases")) {
      app.addMenuLink({
        ...
        Component: () => import("./App-BNU4MEFF.js").then((mod) => ({
          default: mod.App
        })),
      ...
      app.addSettingsLink("global", {
        ...
        permissions: [],
        async Component() {
          const { ProtectedReleasesSettingsPage } = await import("./ReleasesSettingsPage-VCYDDZJW.js");
          return {
      ...
      app.widgets.register([
        {
          ...
          component: async () => {
            const { UpcomingReleasesWidget } = await import("./Widgets-VCMRUWND.js");
      ...
      app.addSettingsLink("global", {
        ...
        permissions: [],
        async Component() {
          const { PurchaseContentReleases } = await import("./PurchaseContentReleases-H5XVPPXC.js");
          return {
...
var StageSelect = ({ isCompact }) => {
  ...
  const { toggleNotification } = useNotification();
  const [{ query }] = useQueryParams();
  const params = React17.useMemo(() => buildValidParams2(query), [
    query
  ]);
  ...
  const [showLimitModal, setShowLimitModal] = React17.useState(null);
  ...
  register(app) {
    ...
    if (window.strapi.features.isEnabled(FEATURE_ID)) {
      ...
      app.addSettingsLink("global", {
        ...
        permissions: [],
        async Component() {
          const { Router } = await import("./router-JW7LNITN.js");
          return {
            default: Router
          };
        }
      ...
      app.widgets.register((widgets) => [
        ...widgets,
        {
          ...
          component: async () => {
            const { AssignedWidget } = await import("./Widgets-2GQBNLD7.js");
      ...
      app.addSettingsLink("global", {
        ...
        permissions: [],
        async Component() {
          const { PurchaseReviewWorkflows } = await import("./purchase-review-workflows-PAMQXHKD.js");
          return {
...
//# sourceMappingURL=chunk-VU3JJ64E.js.map

...
var ModalForm = ({ onToggle }) => {
  ...
  const MagicLink = useEnterprise(MagicLinkCE, async () => (await import("./MagicLinkEE-H7TGIOPV.js")).MagicLinkEE);
...
var ListPageCE = () => {
  ...
  const CreateAction = useEnterprise(CreateActionCE, async () => (await import("./CreateActionEE-GTU6O3GR.js")).CreateActionEE);
                        ...
                        canRead || canDelete ? (0, import_jsx_runtime3.jsx)(Table.Cell, {
                          ...
                          children: (0, import_jsx_runtime3.jsxs)(Flex, {
                            ...
                            children: [
                              ...
                              canDelete && (currentUser == null ? void 0 : currentUser.id) !== user.id ? (0, import_jsx_runtime3.jsx)(IconButton, {
...
var ListPage = () => {
  const UsersListPage = useEnterprise(ListPageCE, async () => (
    ...
    (await import("./ListPage-XI53ZED7.js")).UserListPageEE
  ));
  if (!UsersListPage) {
    return null;
  }
...
//# sourceMappingURL=chunk-JTGVHPL3.js.map

import {
  ...
  QueryClientProvider,
  img
} from "./chunk-XFBPACJS.js";
import {
  ADMIN_PERMISSIONS_CE,
  HOOKS
} from "./chunk-D4LW6POA.js";
import {
  useAIAvailability,
  useNpsSurveySettings
} from "./chunk-JGL2EFET.js";
import {
  useGetAIUsageQuery
} from "./chunk-C47HABOV.js";
import {
  GuidedTourContext
} from "./chunk-RHCHKFLO.js";
import {
  require_pick
} from "./chunk-WYZEO43Y.js";
import {
  getBasename
} from "./chunk-QIJGNK42.js";
import {
  useClipboard
} from "./chunk-P7GLWY5N.js";
import {
  useEnterprise
} from "./chunk-3T6JWHHG.js";
import {
  ADMIN_PERMISSIONS_EE,
  AUDIT_LOGS_DEFAULT_PAGE_SIZE,
  getEERoutes
} from "./chunk-YJLHYIJT.js";
import {
  Login
} from "./chunk-RE3K5QES.js";
import {
  MemoizedInputRenderer
} from "./chunk-GKPOYFWK.js";
import {
  Form
} from "./chunk-OWKUCXRF.js";
import {
  Column,
  LayoutContent,
  Logo,
  UnauthenticatedLayout
} from "./chunk-UBQU4UC3.js";
import {
  ConfigurationProvider
} from "./chunk-GCHR56TI.js";
import {
  require_baseMerge,
  require_createAssigner,
  require_merge,
  require_omit
} from "./chunk-6M3BOWB7.js";
import {
  require_baseRest
} from "./chunk-A5UKLXEO.js";
import {
  HistoryProvider
} from "./chunk-5FZX6XJX.js";
import {
  errorsTrads
...
import {
  ...
  create4 as create2,
  create6 as create3
} from "./chunk-AMVK2ZIL.js";
import {
  Layouts
} from "./chunk-YVZZEJQT.js";
import {
  TrackingProvider,
  useTracking
} from "./chunk-QHMYEW4Z.js";
import {
  createAbsoluteUrl,
  useInitQuery
} from "./chunk-MWZ3LDJ3.js";
import {
  getByteSize
...
} from "./chunk-6KNJWC3Q.js";
import {
  useTypedDispatch,
  useTypedSelector,
  useTypedStore
} from "./chunk-BMZG7DE5.js";
import {
  NotificationsProvider,
  useNotification
} from "./chunk-B6HF4ZKR.js";
import {
  ...
  ...window.strapi.features.isEnabled(window.strapi.features.AUDIT_LOGS) ? [
    {
      path: "audit-logs",
      lazy: async () => {
        const { ProtectedListPage } = await import("./ListPage-C5LU56GG.js");
        return {
  ...
  ...window.strapi.features.isEnabled(window.strapi.features.SSO) ? [
    {
      path: "single-sign-on",
      lazy: async () => {
        const { ProtectedSSO } = await import("./SingleSignOnPage-C2HE4DU3.js");
        return {
...
var AuthPage = () => {
  ...
  const { hasAdmin } = data ?? {};
  const Login$1 = useEnterprise(Login, async () => (await import("./Login-5XCLRTHG.js")).LoginEE);
  const forms = useEnterprise(FORMS, async () => (await import("./constants-QZO27CCV.js")).FORMS, {
...
var ROUTES_CE = [
  {
    lazy: async () => {
      const { ProtectedListPage } = await import("./ListPage-FHDOORQQ.js");
      return {
        Component: ProtectedListPage
      };
    },
  ...
  {
    lazy: async () => {
      const { ProtectedCreatePage } = await import("./CreatePage-GP6MRYAO.js");
      return {
  ...
  {
    lazy: async () => {
      const { ProtectedEditPage } = await import("./EditPage-J73HZEKI.js");
      return {
  ...
  {
    lazy: async () => {
      const { ProtectedListPage } = await import("./ListPage-MPN2Y5OE.js");
      return {
        Component: ProtectedListPage
      };
    },
  ...
  {
    lazy: async () => {
      const { ProtectedEditPage } = await import("./EditPage-24OAI5Z6.js");
      return {
        Component: ProtectedEditPage
      };
    },
  ...
  {
    lazy: async () => {
      const { ProtectedCreatePage } = await import("./CreatePage-ZAVR7GN4.js");
      return {
        Component: ProtectedCreatePage
      };
    },
  ...
  {
    lazy: async () => {
      const editWebhook = await import("./EditPage-G6TW3C6Y.js");
      return {
  ...
  {
    lazy: async () => {
      const { ProtectedListPage } = await import("./ListPage-4OPN7VLL.js");
      return {
        Component: ProtectedListPage
      };
    },
  ...
  {
    lazy: async () => {
      const { ProtectedListView } = await import("./ListView-YW5QFMKC.js");
      return {
  ...
  {
    lazy: async () => {
      const { ProtectedCreateView } = await import("./CreateView-TABTM5RG.js");
      return {
  ...
  {
    lazy: async () => {
      const { ProtectedEditView } = await import("./EditViewPage-ZOGEMTCE.js");
      return {
  ...
  {
    lazy: async () => {
      const { ProtectedCreateView } = await import("./CreateView-3XBQGA7B.js");
      return {
        Component: ProtectedCreateView
      };
    },
  ...
  {
    lazy: async () => {
      const { ProtectedListView } = await import("./ListView-CBV7TITG.js");
      return {
        Component: ProtectedListView
      };
    },
  ...
  {
    lazy: async () => {
      const { ProtectedEditView } = await import("./EditView-QFLKSX46.js");
      return {
        Component: ProtectedEditView
      };
    },
  ...
  {
    lazy: async () => {
      const { ProtectedInstalledPlugins } = await import("./InstalledPlugins-W5RT4KD2.js");
      return {
  ...
  {
    lazy: async () => {
      const { PurchaseAuditLogs } = await import("./PurchaseAuditLogs-EGMAJYVE.js");
      return {
  ...
  {
    lazy: async () => {
      const { PurchaseSingleSignOn } = await import("./PurchaseSingleSignOn-K67YEJKU.js");
      return {
  ...
  {
    lazy: async () => {
      const { PurchaseContentHistory } = await import("./PurchaseContentHistory-EQLRMK2G.js");
      return {
...
var getImmutableRoutes = () => [
  {
    path: "usecase",
    lazy: async () => {
      const { PrivateUseCasePage } = await import("./UseCasePage-AYT5YK24.js");
      return {
...
var getInitialRoutes = () => [
  {
    index: true,
    lazy: async () => {
      const { HomePage } = await import("./HomePage-LNRKN2BS.js");
      return {
        Component: HomePage
      };
    }
  },
  {
    path: "me",
    lazy: async () => {
      const { ProfilePage } = await import("./ProfilePage-L2Q763DC.js");
      return {
  ...
  },
  {
    path: "marketplace",
    lazy: async () => {
      const { ProtectedMarketplacePage } = await import("./MarketplacePage-YHVPMHKT.js");
      return {
  ...
  },
  {
    path: "settings/*",
    lazy: async () => {
      const { Layout } = await import("./Layout-UGOQCP4G.js");
      return {
        Component: Layout
      };
    },
    children: [
      {
        ...
        lazy: async () => {
          const { ApplicationInfoPage } = await import("./ApplicationInfoPage-HRQGFXTV.js");
          return {
    ...
    const routes = [
      {
        ...
        children: [
          ...getImmutableRoutes(),
          {
            path: "/*",
            lazy: async () => {
              const { PrivateAdminLayout } = await import("./AuthenticatedLayout-DTERHUWN.js");
              return {
...
function __variableDynamicImportRuntime4__(path) {
  switch (path) {
    ...
    case "./translations/tr.json":
      return import("./tr.json-VGPAKCBI.js");
...
function __variableDynamicImportRuntime3__(path) {
  switch (path) {
    case "./translations/en-GB.js":
      return import("./en-GB-CBBURFUC.js");
    default:
      return new Promise(function(resolve, reject) {
        (typeof queueMicrotask === "function" ? queueMicrotask : setTimeout)(
          reject.bind(null, new Error("Unknown variable dynamic import: " + path))
    ...
    this.widgets.register([
      {
        ...
        component: async () => {
          const { ProfileWidget } = await import("./Widgets-UCKFXCRW.js");
      ...
      },
      {
        ...
        component: async () => {
          const { KeyStatisticsWidget } = await import("./Widgets-UCKFXCRW.js");
      ...
      this.widgets.register([
        {
          ...
          component: async () => {
            const { AuditLogsWidget } = await import("./Widgets-XJSEOPE6.js");
...
//# sourceMappingURL=chunk-7VWK7FPD.js.map

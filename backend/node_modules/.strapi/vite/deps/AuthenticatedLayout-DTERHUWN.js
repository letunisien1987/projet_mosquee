...
import {
  DndProvider
} from "./chunk-BSCIW46B.js";
import "./chunk-C47HABOV.js";
import {
  tours,
  useIsDesktop,
...
import "./chunk-3T6JWHHG.js";
import {
  useConfiguration
} from "./chunk-GCHR56TI.js";
import "./chunk-QU552CNO.js";
import {
  format,
  isAfter,
  isBefore,
  startOfToday,
  subDays
} from "./chunk-QIYIGWSY.js";
import "./chunk-YHY5LPEI.js";
...
import "./chunk-FIAISLMB.js";
import "./chunk-AMVK2ZIL.js";
...
import "./chunk-B6HF4ZKR.js";
import {
  HEIGHT_TOP_NAVIGATION,
  RESPONSIVE_DEFAULT_SPACING
} from "./chunk-PWWLPW7X.js";
import "./chunk-S6IM2GFI.js";
import "./chunk-SUISKH45.js";
...
var package_default = {
  ...
  dependencies: {
    ...
    "@strapi/permissions": "5.31.2",
    "@strapi/types": "5.31.2",
    "@strapi/typescript-utils": "5.31.2",
    "@strapi/utils": "5.31.2",
...
function PopChild({ children, isPresent, anchorX, root }) {
  ...
  return (0, import_jsx_runtime5.jsx)(PopChildMeasure, { isPresent, childRef: ref, sizeRef: size, children: React2.cloneElement(children, { ref: composedRef }) });
}
...
var PresenceChild = ({ children, initial, isPresent, onExitComplete, custom, presenceAffectsLayout, mode, anchorX, root }) => {
  ...
  if (mode === "popLayout") {
    children = (0, import_jsx_runtime6.jsx)(PopChild, { isPresent, anchorX, root, children });
  }
...
var AnimatePresence = ({ children, custom, initial = true, onExitComplete, presenceAffectsLayout = true, mode = "sync", propagate = false, anchorX = "left", root }) => {
  ...
  return (0, import_jsx_runtime7.jsx)(import_jsx_runtime7.Fragment, { children: renderedChildren.map((child) => {
    ...
    return (0, import_jsx_runtime7.jsx)(PresenceChild, { isPresent, initial: !isInitialRender.current || initial ? void 0 : false, custom, presenceAffectsLayout, mode, root, onExitComplete: isPresent ? void 0 : onExit, anchorX, children: child }, key);
  }) });
};
...
function useVisualElement(Component3, visualState, props, createVisualElement, ProjectionNodeConstructor) {
  ...
  const wantsHandoff = (0, import_react28.useRef)(Boolean(optimisedAppearId) && !((_a = window.MotionHandoffIsComplete) == null ? void 0 : _a.call(window, optimisedAppearId)) && ((_b = window.MotionHasOptimisedAnimation) == null ? void 0 : _b.call(window, optimisedAppearId)));
  useIsomorphicLayoutEffect(() => {
    if (!visualElement)
      return;
...
function ReorderItemComponent({ children, style = {}, value, as = "li", onDrag, layout: layout2 = true, ...props }, externalRef) {
  const Component3 = useConstant(() => motion[as]);
  const context = (0, import_react51.useContext)(ReorderContext);
  const point = {
...
var NavUser = ({ initials, showDisplayName = false, children, ...props }) => {
  ...
  return (0, import_jsx_runtime16.jsx)(Flex, {
    ...props,
    children: (0, import_jsx_runtime16.jsxs)(Menu.Root, {
      children: [
          ...
          children: (0, import_jsx_runtime16.jsxs)(Flex, {
            ...
            children: [
              (0, import_jsx_runtime16.jsx)(MenuIcon, {
                justifyContent: "center",
                children: (0, import_jsx_runtime16.jsx)(Avatar.Item, {
                  delayMs: 0,
                  fallback: initials || getInitials(user)
                })
              }),
              showDisplayName ? (0, import_jsx_runtime16.jsx)(Typography, {
                variant: "omega",
                children: children || userDisplayName
              }) : (0, import_jsx_runtime16.jsx)(VisuallyHidden, {
                tag: "span",
                children: children || userDisplayName
              })
            ]
        ...
        (0, import_jsx_runtime16.jsxs)(MenuContent, {
          ...
          children: [
            (0, import_jsx_runtime16.jsxs)(UserInfo, {
              ...
              children: [
                (0, import_jsx_runtime16.jsx)(Typography, {
                  variant: "omega",
                  fontWeight: "bold",
                  textTransform: "none",
                  children: children || userDisplayName
                ...
                (0, import_jsx_runtime16.jsx)(BadgeWrapper, {
                  children: (_a = user == null ? void 0 : user.roles) == null ? void 0 : _a.map((role) => (0, import_jsx_runtime16.jsx)(Badge, {
                    children: role.name
                  }, role.id))
                })
              ]
            }),
            (0, import_jsx_runtime16.jsx)(Menu.Separator, {}),
            (0, import_jsx_runtime16.jsx)(Menu.Item, {
...
var NavBurgerMenu = ({ isShown, handleClickOnLink, onClose, listLinks }) => {
  return (0, import_jsx_runtime17.jsx)(Portal$1, {
    children: (0, import_jsx_runtime17.jsx)(AnimatePresence, {
      children: isShown && (0, import_jsx_runtime17.jsx)(FocusTrap, {
        onEscape: onClose,
        children: (0, import_jsx_runtime17.jsx)(MotionLayer, {
          ...
          children: (0, import_jsx_runtime17.jsx)(Surface, {
            children: (0, import_jsx_runtime17.jsx)(ScrollAreaImpl$1, {
              children: (0, import_jsx_runtime17.jsxs)(Box, {
                tag: "ul",
                paddingLeft: {
                  initial: 4,
                  medium: 6
...
var TrialCountdown = () => {
  ...
  return (0, import_jsx_runtime18.jsx)(Container, {
    justifyContent: "center",
    padding: 3,
    children: (0, import_jsx_runtime18.jsx)(TooltipImpl, {
    ...
    children: [
      (0, import_jsx_runtime19.jsxs)(MainNav, {
        children: [
          ...
          (0, import_jsx_runtime19.jsx)(Divider, {}),
          (0, import_jsx_runtime19.jsxs)(MenuDetails, {
            children: [
              ...
              (0, import_jsx_runtime19.jsx)(Box, {
                display: {
                  initial: "none",
                  large: "flex"
                },
          ...
          (0, import_jsx_runtime19.jsx)(Box, {
            ...
            children: (0, import_jsx_runtime19.jsx)(IconButton, {
              ...
              children: !isBurgerMenuShown ? (0, import_jsx_runtime19.jsx)(ForwardRef$1e, {
                fill: "neutral1000"
              }) : (0, import_jsx_runtime19.jsx)(ForwardRef$26, {
                fill: "neutral1000"
              })
            })
          })
...
var Banner = ({ isTrialEndedRecently }) => {
  const { formatMessage } = useIntl();
  return (0, import_jsx_runtime21.jsx)(BannerBackground, {
    width: "100%",
    justifyContent: "center",
    children: (0, import_jsx_runtime21.jsxs)(Flex, {
      justifyContent: "center",
      alignItems: "center",
      width: "100%",
      paddingTop: 2,
      ...
      gap: 2,
      children: [
        (0, import_jsx_runtime21.jsxs)(Box, {
          children: [
            (0, import_jsx_runtime21.jsx)(Typography, {
              variant: "delta",
              fontWeight: "bold",
              textColor: "neutral0",
              textAlign: "center",
        ...
        (0, import_jsx_runtime21.jsx)(Box, {
          children: (0, import_jsx_runtime21.jsx)(LinkButton, {
            width: "max-content",
            variant: "tertiary",
    ...
    children: [
      ...
      (0, import_jsx_runtime22.jsx)(PluginsInitializer, {
        children: (0, import_jsx_runtime22.jsx)(DndProvider, {
          ...
          children: (0, import_jsx_runtime22.jsxs)(Box, {
            background: "neutral100",
            children: [
              (0, import_jsx_runtime22.jsx)(SkipToContent, {
                children: formatMessage({
                  id: "skipToContent",
                  defaultMessage: "Skip to content"
                })
              }),
              (0, import_jsx_runtime22.jsxs)(Flex, {
                height: "100dvh",
                direction: {
                  initial: "column",
                  large: "row"
                ...
                children: [
                  ...
                  (0, import_jsx_runtime22.jsxs)(Box, {
                    flex: 1,
                    overflow: "auto",
                    width: "100%",
                    height: {
...
//# sourceMappingURL=AuthenticatedLayout-DTERHUWN.js.map

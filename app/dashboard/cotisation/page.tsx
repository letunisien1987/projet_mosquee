...
export default async function CotisationPage() {
  ...
  return (
    <div className="max-w-7xl mx-auto">
      ...
      {/* Statut actuel */}
      {currentMembership ? (
        <div className="bg-gradient-to-r from-primary to-primary-dark rounded-xl shadow-lg p-6 text-white mb-8">
          <div className="flex items-center justify-between mb-4">
            ...
            <div className="text-right">
              <div className="text-sm text-white/80">Valide jusqu&apos;au</div>
                      ...
                      <tr key={membership.id} className="hover:bg-gray-50 dark:hover:bg-gray-700/50 transition-colors">
                        <td className="px-6 py-4">
                          <div className="flex items-center gap-3">
                            <div className="w-10 h-10 bg-primary/10 rounded-lg flex items-center justify-center flex-shrink-0">
                              <MemberIcon className="h-5 w-5 text-primary" />
                            </div>
                            <div>
                        ...
                        <td className="px-6 py-4">
                          <span className={`inline-flex items-center gap-1 px-2.5 py-1 rounded-full text-xs font-medium ${
                            ...
                            {membership.paymentStatus === 'PAID' ? 'Payé' : membership.paymentStatus === 'REFUNDED' ? 'Remboursé' : membership.paymentStatus}
                          </span>
                        </td>
                      </tr>
                    )

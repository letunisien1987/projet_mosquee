    ...
    return (
      <div className="bg-white dark:bg-gray-800 rounded-lg shadow-sm border border-gray-200 dark:border-gray-700 overflow-hidden hover:shadow-md transition-shadow">
            ...
            <div className="flex items-center gap-1">
              {offering.published ? (
                <span className="flex items-center gap-1 text-xs text-green-600 dark:text-green-400">
                  <CheckCircle className="h-3 w-3" /> Publie
                </span>
              ) : (
        ...
        <div className="px-4 py-3 bg-gray-50 dark:bg-gray-900/50 border-t border-gray-100 dark:border-gray-700 flex items-center justify-end gap-2">
          <Link
            href={`/dashboard/admin/gestion/${offering.id}`}
          ...
          <Link
            href={`/dashboard/admin/gestion/${offering.id}/modifier`}
      ...
      <div className="flex flex-col md:flex-row md:items-center md:justify-between gap-4">
        <div>
          ...
          <p className="text-gray-600 dark:text-gray-400 mt-1">
            Gerez vos evenements et activites depuis une interface unique
          </p>
        </div>
        <Link
          href="/dashboard/admin/gestion/nouveau"
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
        ...
        <div className="bg-white dark:bg-gray-800 rounded-lg p-4 shadow-sm border border-gray-200 dark:border-gray-700">
          <div className="flex items-center gap-3">
            ...
            <div>
              <p className="text-sm text-gray-600 dark:text-gray-400">Evenements</p>
        ...
        <div className="flex flex-col md:flex-row gap-4">
          <div className="flex items-center gap-2">
            ...
            >
              ...
              <option value="EVENT">Evenements uniquement</option>
              <option value="ACTIVITY">Activites uniquement</option>
            </select>
          </div>
        ...
        <div className="bg-white dark:bg-gray-800 rounded-lg shadow-sm border border-gray-200 dark:border-gray-700 p-12 text-center">
          ...
          <p className="text-gray-600 dark:text-gray-400 mb-4">
            {searchQuery
              ...
              : 'Commencez par creer votre premiere offre'}
          </p>
          <Link
            href="/dashboard/admin/gestion/nouveau"
            className="inline-flex items-center gap-2 px-4 py-2 bg-emerald-600 text-white rounded-lg hover:bg-emerald-700 transition-colors"
          ...
          <table className="w-full">
            <thead className="bg-gray-50 dark:bg-gray-900/50 border-b border-gray-200 dark:border-gray-700">
              <tr>
                ...
                <th className="px-4 py-3 text-center text-xs font-medium text-gray-500 uppercase">Publie</th>

...
export default function ServicesPage() {
  ...
  return (
    <div className="space-y-6">
      <div>
        <h1 className="text-2xl font-bold text-gray-900 dark:text-white">Demandes de Services</h1>
        <p className="text-gray-600 dark:text-gray-400 mt-1">Gestion des demandes de services religieux</p>
      </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-5 gap-6">
        ...
        <div className="bg-white dark:bg-gray-800 rounded-lg shadow p-6">
          <div className="flex items-center justify-between">
            <div>
              <p className="text-sm text-gray-500 dark:text-gray-400">Completes</p>
        ...
        <div className="flex flex-col md:flex-row gap-4">
          <div className="flex-1">
            <div className="relative">
              ...
              <input
                type="text"
                placeholder="Rechercher par nom ou details..."
                value={searchTerm}
          ...
          <div className="flex items-center gap-2">
            ...
            >
              ...
              <option value="FUNERAL">Funerailles</option>
                  ...
                  return (
                    <tr key={request.id} className="hover:bg-gray-50 dark:hover:bg-gray-700">
                      <td className="px-6 py-4 whitespace-nowrap">
                        <span className="text-sm font-medium text-gray-900 dark:text-white">{getTypeLabel(request.serviceType)}</span>
                      </td>
                      <td className="px-6 py-4 whitespace-nowrap">
                      ...
                      <td className="px-6 py-4 whitespace-nowrap text-sm text-gray-900 dark:text-white">
                        {request.requestDate ? (
                          ...
                          <span className="text-gray-500">Non specifiee</span>
                        )}
                      </td>
                      <td className="px-6 py-4 whitespace-nowrap">
        ...
        >
          ...
          >
            <div className="flex items-center justify-between mb-4">
              <h3 className="text-xl font-bold text-gray-900 dark:text-white">Demande de service - {getTypeLabel(selectedRequest.serviceType)}</h3>
              <button
                onClick={() => setSelectedRequest(null)}
            ...
            <div className="space-y-4">
              ...
              <div>
                <label className="text-sm font-medium text-gray-500 dark:text-gray-400">Date souhaitee</label>
              ...
              <div>
                ...
                <p className="mt-2 whitespace-pre-wrap text-gray-900 dark:text-white">{selectedRequest.details}</p>
              </div>
              ...
              <div>
                ...
                <p className="text-gray-900 dark:text-white">{format(new Date(selectedRequest.createdAt), 'dd MMMM yyyy a HH:mm', { locale: fr })}</p>
              </div>
            </div>

    ...
    try {
      ...
      if (res.ok) {
        ...
        setFormData({
          ...
          subscription_interval: event.subscription_interval || 'MONTHLY',
          // Tarification avancée
          ...
          restrictions: {
            ...
            participation_type: event.restrictions?.participation_type || 'INDIVIDUAL',
            allowed_gender: event.restrictions?.allowed_gender || 'ALL',

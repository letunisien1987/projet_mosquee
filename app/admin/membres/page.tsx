...
export default function MembresPage() {
  ...
  const handleSendReminder = async (user: User) => {
    if (!confirm(`Envoyer un rappel de cotisation à ${user.firstName} ${user.lastName} ?`)) return
  ...
  const handleRefund = async (membership: Membership) => {
    if (!confirm('Êtes-vous sûr de vouloir effectuer un remboursement ? Cette action est irréversible.')) return
  ...
  const handleCloseMembership = async (membership: Membership) => {
    if (!confirm('Êtes-vous sûr de vouloir clôturer cette cotisation ?')) return
    ...
    <div className="space-y-6">
      ...
      <div className="grid grid-cols-1 md:grid-cols-4 gap-6">
        ...
        <div className="bg-white dark:bg-gray-800 rounded-lg shadow p-6">
          <div className="flex items-center justify-between">
            <div>
              <p className="text-sm text-gray-500 dark:text-gray-400">Cotisations Expirées</p>
                      ...
                      <td className="px-6 py-4 whitespace-nowrap text-sm">
                        {activeMembership ? (
                          ...
                          <div className="text-orange-600 dark:text-orange-400">
                            Expirée le {format(new Date(user.memberships[0].endDate), 'dd MMM yyyy', { locale: fr })}
                          </div>
                        ) : (
            ...
            <div className="grid md:grid-cols-2 gap-6 mb-6">
              ...
              <div className="bg-gray-50 dark:bg-gray-900 rounded-lg p-4">
                ...
                <div className="space-y-4">
                  ...
                  <div className="flex items-center justify-between">
                    <span className="text-gray-600 dark:text-gray-400">Événements</span>
                    <span className="font-bold text-lg text-gray-900 dark:text-white">
      ...
      {showRoleModal && selectedUser && (
        <div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center p-4 z-50">
          <div className="bg-white dark:bg-gray-800 rounded-lg max-w-md w-full p-6">
            <h2 className="text-2xl font-bold mb-4 text-gray-900 dark:text-white">Changer le rôle</h2>
            <div className="mb-4">
